...
func (g *Galleries) Create(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		// TODO: make this go to galleries index page
...
// ImageUpload POST /galleries/:id/images -check this route later
func (g *Galleries) ImageUpload(w http.ResponseWriter, r *http.Request) {
	...
	// create the directory to hold our images
	galleryPath := fmt.Sprintf("images/gallery/%v/", gallery.ID)
...
func (g *Galleries) galleryByID(w http.ResponseWriter, r *http.Request) (*models.Gallery, error) {
	...
	if err != nil {
		...
		case models.ErrNotFound:
			http.Error(w, "Gallery not found", http.StatusNotFound)
		default:
			http.Error(w, "Oh no! Something's broken!", http.StatusNotFound)
		}
		return nil, err
	}
	return gallery, nil
